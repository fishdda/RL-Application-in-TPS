...
#        xml_path_output = 'C:/Users/xhuae08006/Desktop/XHTOMO_AUTO/Modifier/test_dosenormsettings.xml'
    ...
    def Write_Template_551(self,pt_id_list,delivery_method_list,updated_IMRT_CONSTRAINT_TABLE):
        '''
        ...
        name = pt_id_list[0]+delivery_method_list[0]+'.hyp'
        new_path = os.path.join(self.updated_template_path,name)
...
class Initialization_MON551(HYP_Editor_MONACO551):    
    ...
    def MAIN_Tune_TP_551(self,
        ...
        DVH_JSON: 'C:/auto template/dvh/DVHStatistics.json' # need to change
        '''
        import random 
        import time
        
        flag = HYP_Editor_MONACO551.read_flag(self)   #read flag file
        while flag == '1':

            time.sleep(5)   #This time sleep is for Monaco Calculation

            flag = HYP_Editor_MONACO551.read_flag(self)      
        ...
        if flag == '0':
                ...
                line,strt_index,IMRT_TABLE = HYP_Editor_MONACO551.Read_Template_551(self)  #read template information
                
                dvh_stat_calc = HYP_Editor_MONACO551.DVH_Stat_Extract_JSON(self,DVH_JSON)  #read DVH Statistics Information from Monaco TPS                   
...
#            level_OARs
        ...
        HYP_Editor_MONACO551.Write_Template_551(self,pt_id_list,delivery_method_list,updated_IMRT_CONSTRAINT_TABLE)
        # struct_fun = HYP_Editor_MONACO551.back_strt_fun(line,strt_index,line,self.path[-1],inf['isc'],self.ind[2][1],self.ind[0][1])             
        ...
        #     HYP_Editor_MONACO551.show_OARs(self,diff_result,tar_res_nam)
            
        #     HYP_Editor_MONACO551.write_template(self,line,struct_fun_updated) # transfer the updated template to .hyp
            
            
            # write flag to 1 to tell Monaco could reload template and calculate again
            HYP_Editor_MONACO551.write_flag(self)
        ...
        #     HYP_Editor_MONACO551.write_template(self,line,struct_fun_updated)
